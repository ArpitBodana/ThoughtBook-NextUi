  ...
  return (
    <div className="bg-rose-100 text-zinc-800 font-body p-8">
      ...
      <p>
        ...
        of ThoughtBook's Website, located at https://mythoughtbook.tk/.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use ThoughtBook if you do not agree to
      ...
      <h3 className="text-2xl mb-3 mt-3">
        <strong>Cookies</strong>
      </h3>

      <p>
        We employ the use of cookies. By accessing ThoughtBook, you agreed to
        use cookies in agreement with the ThoughtBook's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, ThoughtBook and/or its licensors own the
        intellectual property rights for all material on ThoughtBook. All
        intellectual property rights are reserved. You may access this from
        ThoughtBook for your own personal use subjected to restrictions set in
      ...
      <p>
        ...
        ThoughtBook does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of ThoughtBook,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, ThoughtBook shall not be
      ...
      <p>
        ThoughtBook reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant ThoughtBook a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of ThoughtBook; and (d) the link
      ...
      <p>
        ...
        e-mail to ThoughtBook. Please include your name, your organization name,
      ...
      <p>
        No use of ThoughtBook's logo or other artwork will be allowed for

  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="  Thoughtbook webapp for anyone who is intrested in reading famous thought or add your own thoughts that are read by others"
        />
        <meta
          name="keywords"
                  ...
                  <Link href={`thought/${post.id}`}>
                    <a>
                      ...
                      <div className="grid mt-4">
                        <span className="text-xl md:text-2xl text-justify font-body">
                          {post.thought}
                        </span>
                        <br />
...
export async function getServerSideProps() {
  const response = await fetch(
    "https://chikubodana.pythonanywhere.com/api/v1/thoughtbook/generic/"
  );

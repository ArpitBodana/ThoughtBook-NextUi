                        ...
                        if (post.user === username) {
                            return (
                                ...
                                <form className='' key={post.id} >
                                    ...
                                    <br></br>
                                    <span className=" m-4 mb-3 m font-body  flex justify-between md:justify-center">
                                        <Button  className=" m-4 mb-3 m font-body text-black bg-orange-400"  onClick={() => handleEdit(post.id, post.thought, post.author, post.user)} variant="outlined" color='error' >Save</Button>
                                        <Button  className='m-4 mb-3 font-body   bg-stone-800 text-blue-600' onClick={() => handleDelete(post.id, post.user)} variant="outlined" color='info' >Delete</Button>
                                    </span>
                                </form>
                            )
                        }
